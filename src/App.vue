  ...
  methods: {
	  ...
	  deriveWindDir: function(windDir) {
		  var wind_directions_array = [
			  ...
			  { minVal: 211, maxVal: 225, direction: 'SSO' },
			  { minVal: 226, maxVal: 255, direction: 'SO' },
			  { minVal: 256, maxVal: 270, direction: 'OSO' },
			  { minVal: 271, maxVal: 300, direction: 'O' },
			  { minVal: 301, maxVal: 315, direction: 'ONO' },
			  { minVal: 316, maxVal: 345, direction: 'NO' },
			  { minVal: 346, maxVal: 360, direction: 'NNO' }
		  ];
		  var wind_direction = '';
